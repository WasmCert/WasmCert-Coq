...
Proof. (* TODO: go through proof and use seq_can_trap_ctx instead of wp_seq, which can be quite tedious.. 
       next up, do all the trap cases in the remaining part of the proof.
     *)
    Admitted.
(*
  iIntros "!>" (Ξ) "(%Hinstmem & %Hlocs0 & %Hlocs1 & %Hlocs & %Hvb & %Hv & Hs & HΦ & %Htypes & %Htab & Htab & Hcl & %Hclt & #Hspec & Hf) HΞ" => /=.
