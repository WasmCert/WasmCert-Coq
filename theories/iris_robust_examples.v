...
Require Export iris_rules iris_fundamental.
...
Notation "{{{ P }}} es {{{ v , Q }}}" :=
  (∀ Φ, P -∗ (∀ v, Q -∗ Φ v) -∗ WP es @ NotStuck ; ⊤ {{ v, Φ v }}) (at level 50).
...
Section Examples.
  ...
  Context `{!wfuncG Σ, !wtabG Σ, !wtabsizeG Σ, !wmemG Σ, !wmemsizeG Σ, !wglobG Σ, !wframeG Σ, !logrel_na_invs Σ, HWP:host_program_logic}.
