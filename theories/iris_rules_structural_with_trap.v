...
Lemma trap_context_reduce hs locs s LI lh k :
  ...
  ∃ e', reduce (host_instance:=DummyHosts.host_instance) hs locs s LI hs locs s e'.
Proof.
  revert LI lh.
...
Lemma to_val_trapV_label_None es k lh LI :
...
Proof.
  ...
  destruct i;auto.
  exfalso.
  apply to_val_trapV_label_None in Hfill;auto.
  congruence.
Qed.
