...
val invoke_func : Output.verbosity -> host_extern_store -> (Interpreter.store_record * Extract.frame) -> Extract.value0 list -> string -> string -> (Interpreter.store_record * (Extract.value0 list) option) Host.host_event
