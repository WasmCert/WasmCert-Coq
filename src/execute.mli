...
val interpret : Output.verbosity -> bool -> ((Extract.Equality.sort * Interpreter.store_record) * Extract.instance) * Extract.module_export list -> string -> int -> unit Host.host_event

val interpret_ctx : Output.verbosity -> bool -> ((Extract.Equality.sort * Interpreter.store_record) * Extract.instance) * Extract.module_export list -> string -> int -> unit Host.host_event
...
val instantiate_interpret : Output.verbosity -> bool -> bool -> bool -> Extract.module0 -> string -> int -> unit Host.host_event
